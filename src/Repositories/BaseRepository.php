...
use Mukul\Matrixusermanagement\Contracts\BaseContract;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\ModelNotFoundException;
/**
 * Class BaseRepository
 *
 * @package \Mukul\Matrixusermanagement\Repositories
 */
class BaseRepository implements BaseContract
{
    ...
    {
        return $this->model->onlyTrashed()->where('company_id', auth()->user()->company_id)->restore();
    }
}
